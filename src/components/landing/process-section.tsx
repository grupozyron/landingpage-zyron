...
const steps = [

  {
    ...
    body: "Entendemos seu negócio, dor e oportunidade real de escala.",
...

  {
    ...
    title: "Estruturamos sua presença digital",

    body: "Landing, mensagem e experiência alinhadas ao ticket e à marca.",
...

  {
    ...
    title: "Ativamos campanhas",

    body: "Tráfego pago com foco em conversão — não em vaidade de métrica.",
...

  {
    ...
    title: "Implementamos automações",

    body: "IA no WhatsApp, fluxos e ritmo comercial sem depender só de sorte.",
...

  {
    ...
    body: "Otimização contínua e expansão do que comprova retorno.",
      ...
      <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
        ...
        <Reveal>
          ...
          <p className="mt-4 max-w-2xl text-[15px] leading-relaxed text-muted-foreground">
            ...
            Um fluxo claro — da análise ao crescimento mensurável.
